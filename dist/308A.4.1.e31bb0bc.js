      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          data.forEach(function (breed) {
            ...
            option.innerHTML = "".concat(toTitleCase(breed.name));
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return fetch("https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=".concat(e.target.value));
                  case 2:
                  ...
                  case 5:
                    ...
                    cats.forEach(function (cat) {
                      ...
                      img.id = "".concat(cat.id);
                      img.alt = "".concat(breedSelect.value);
