...
function createCarouselItem(imgSrc, imgAlt, imgId) {
  ...
  img.src = imgSrc;
  img.alt = imgAlt;
  var favBtn = clone.querySelector(".favorite-button");
  favBtn.addEventListener("click", function () {
    (0, _index.favorite)(imgId);
  });
  return clone;
}
function clear() {
...
var API_KEY = "live_f442WpIpdmrvNYLgvqJ0J8GK7oIq3nbSIci46khmdQGVzslHpzf6QNYWy5vjyM9A";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          data.forEach(function (breed) {
            ...
            option.setAttribute("value", "".concat(breed.id));
            option.innerHTML = "".concat(toTitleCase(breed.id));
...
function breedSelectEventHandler() {
  return _breedSelectEventHandler.apply(this, arguments);
}
function _breedSelectEventHandler() {
  _breedSelectEventHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, data;
...
var imgSrc = "./bird.jpeg";
var imgAlt = "Funny cat";
var imgId = "Catty";
/**
...
//# sourceMappingURL=/308A.4.1.e31bb0bc.js.map